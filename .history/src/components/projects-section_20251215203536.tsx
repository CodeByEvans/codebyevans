...
// --- Componente Banner (Con la corrección del material y ajuste de tamaño/posición) ---
...
const Banner = (props: BannerProps) => {
  // Eliminamos props, ya no las usamos
  ...
  return (
    // CAMBIOS CLAVE:
    // 1. Posición Z ajustada a -1.5 para moverlo hacia atrás.
    <mesh ref={meshRef} position={[0, -0.15, -1.5]}>
      {/* 2. Radio del cilindro ajustado a 1.8 (el carrusel está en 1.4) */}
