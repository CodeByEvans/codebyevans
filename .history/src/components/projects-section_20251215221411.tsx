  ...
  return (
    ...
    >
      ...
      <Html
        center
        distanceFactor={5}
        className="w-[380px] h-[500px] pointer-events-auto hover:scale-105 hover:shadow-2xl hover:shadow-black/50 transition duration-300 ease-in-out"
      >
        <div
    ...
    <section id="proyectos" className="w-full">
      ...
      <AnimatePresence>
        {activeProject && (
          ...
          >
            <motion.div
              className="relative max-w-3xl w-full max-h-[90vh] mx-4 overflow-hidden rounded-2xl bg-neutral-900 shadow-2xl"
