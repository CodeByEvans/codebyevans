...
export function Header() {
  ...
  return (
    ...
    >
      <div className="container mx-auto w-full px-4 py-3 flex items-center justify-between">
        {/* Logo */}
        <a
          href="/"
          className="flex items-center px-6 font-mono text-primary font-semibold hover:opacity-90 transition-opacity"
        >
