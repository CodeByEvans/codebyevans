  ...
  return (
    <section id="proyectos" className="w-full">
      ...
      {activeProject && (
        ...
        >
          <div
            className="relative max-w-3xl w-full mx-4 bg-neutral-900 rounded-2xl p-6"
          ...
          >
            ...
            <p className="text-white/80 mb-4">{activeProject.summary}</p>

            {/* aquí ya te puedes flipar */}
            {/* imágenes, links, stack, vídeos, lo que quieras */}
          </div>
        </div>
      )}
    </section>
